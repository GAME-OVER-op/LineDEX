...
public final class MagicDeskRuntimeService extends Service
    ...
    private static final String ACTION_SHOW_MAGIC_DESK =
            "com.linedex.desktop.action.SHOW_MAGIC_DESK";
    private static final String ACTION_OPEN_TOUCHPAD =
            "com.linedex.desktop.action.OPEN_TOUCHPAD";
    ...
    private void showStart() {
        ...
        final int displayId = getConsoleDisplayId();
        if (displayId > 0) {
    ...
    private boolean shouldRunConsoleMouseBridge() {
        // Physical mouse routing is owned by the LSPosed system_server hook.
        // Starting the inherited Nubia uinput bridge would duplicate events.
        return false;
    }
    ...
    private int getConsoleDisplayId() {
        final int bridgeDisplayId = ConsoleModeSwitcher.getActiveConsoleDisplayId();
        if (bridgeDisplayId > 0 && mDisplayManager != null
